...
<html lang="sr">
  <head>
    ...
    <title>Izrada web sajtova | Mona Nekretnine | Održavanje sajtova</title>
    <!-- Bootstrap -->
  ...
  <!-- Main START -->
    <section class="reference-full">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>Mone Nekretnine</h1>
            <img src="/img/monaref1.jpg" alt="Dunav auto NS" class="img-responsive">
          </div>
          <div class="col-md-4 desc">
            <h3>Kratak opis projekta</h3>
            <p>Izrada web sajta za agenciju Mona Nekretnine koja se bavi izdavanjem i prodajom stanova. Sajt je prilagođen svim ekranima. Sastoji se od stranice koja sadrži slajder, pretragu stanova u artikle koji su smešteni u bazi podataka. Posebna stranica je izdvojena za mogućnost oglašavanja nekretnina, sa opcijom da se uploaduju slike. Poseduje kontakt stranicu sa google mapom i kontakt formom preko koje je moguće poslati poruku.</p>
            <p class="klijent"><strong>Klijent:</strong>&nbsp; Mona Nekretnine</p>
            <p class="godina"><strong>Godina izrade:</strong>&nbsp;2019</p>
            <a href="https://monanekretnine.rs/" class="btn btn-default btnredirect" target="_blanc">Poseti stranicu &nbsp;<i class="fas fa-caret-right"></i></a>
          </div>
        </div>
      </div>
    </section>
