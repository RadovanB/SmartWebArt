...
<html lang="sr">
  <head>
    ...
    <title>Izrada web sajtova | Renta Car Inter Buy | Održavanje sajtova</title>
    <!-- Bootstrap -->
  ...
  <!-- Main START -->
    <section class="reference-full">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>RENTA CAR INTER BUY</h1>
            <img src="/img/renta-car-inter-buy-ref.jpg" alt="Servis Robot" class="img-responsive">
          </div>
          <div class="col-md-4 desc">
            <h3>Kratak opis projekta</h3>
            <p>Izrada web sajta za firmu INTER BUY iz Beograda. Sajt sadrži moderan meni sa slajderom. Početna stranica sadrži sekciju pošalji upit preko koje je moguće slanje zahteva za iznajmljivanje vozila. Sadrži informativne stranice o nama i uslovi iznajmljivanja vozila. Kontakt stranica sadrži mapu sa lokacijom i kontakt formu. Sajt je responzivan i prilagođen svim veličinama ekrana. Na stranici vozni park se nalazi prikaz trenutno raspoloživih vozila za renta car.</p>
            <p class="klijent"><strong>Klijent:</strong>&nbsp; Inter Buy</p>
            <p class="godina"><strong>Godina izrade:</strong>&nbsp;2020</p>
            <a href="http://rentacar.interbuy.rs/" class="btn btn-default btnredirect" target="_blanc">Poseti stranicu &nbsp;<i class="fas fa-caret-right"></i></a>
          </div>
        </div>
      </div>
    </section>
