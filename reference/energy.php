...
<html lang="sr">
  <head>
    ...
    <title>Izrada web sajtova | Energy Contact Mont | Održavanje sajtova</title>
    <!-- Bootstrap -->
  ...
  <!-- Main START -->
    <section class="reference-full">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>ENERGY CONTACT MONT</h1>
            <img src="/img/energycontact-ref.jpg" alt="Energy Contact Mont" class="img-responsive">
          </div>
          <div class="col-md-4 desc">
            <h3>Kratak opis projekta</h3>
            <p>Sajt je trenutno u fazi izrade ...</p>
            <p class="klijent"><strong>Klijent:</strong>&nbsp; Ivan Djurovski</p>
            <p class="godina"><strong>Godina izrade:</strong>&nbsp;2020</p>
            <a href="http://test.energycontact.rs/" class="btn btn-default btnredirect" target="_blanc">Poseti stranicu &nbsp;<i class="fas fa-caret-right"></i></a>
          </div>
        </div>
      </div>
    </section>
