...
<html lang="sr">
  <head>
    ...
    <title>Izrada web sajtova | Servis Robot | Jeftina izrada sajtova Valjevo</title>
    <!-- Bootstrap -->
    ...
    <section class="reference-full">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>SERVIS ROBOT</h1>
            <img src="/img/servisrobotref.jpg" alt="Servis Robot" class="img-responsive">
          </div>
          <div class="col-md-4 desc">
            <h3>Kratak opis projekta</h3>
            <p>Izrada web sajta za firmu SERVIS ROBOT iz Beograda. Sajt sadrži swiper u meniju, slajder sa pokretnim tekstom i stranicu sa galerijom. Na kontakt stranici je implementirana google mapa i omogućeno je slanje upita preko kontakt forme. Sajt je responzivan i prilagođen svim veličinama ekrana. Ovaj tip sajta je odličan za mali biznis koji nastupa po prvi put na internetu sa svojom prezentacijom.</p>
            <p class="klijent"><strong>Klijent:</strong>&nbsp; Servis Robot</p>
            <p class="godina"><strong>Godina izrade:</strong>&nbsp;2020</p>
            <a href="http://servisrobot.com/" class="btn btn-default btnredirect" target="_blanc">Poseti stranicu &nbsp;<i class="fas fa-caret-right"></i></a>
          </div>
        </div>
      </div>
    </section>
