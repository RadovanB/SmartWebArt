...
<html lang="sr">
  <head>
    ...
    <title>Izrada web sajtova | Unikom Plus | Održavanje sajtova</title>
    <!-- Bootstrap -->
    ...
    <section class="reference-full">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>Unikom Plus</h1>
            <img src="/img/unikomref.jpg" alt="Unikom Plus" class="img-responsive">
          </div>
          <div class="col-md-4 desc">
            <h3>Kratak opis projekta</h3>
            <p>*Web sajt još uvek u fazi izrade</p>
            <p>Izrada web sajta za firmu Unikom Plus iz Nove Pazove koja se bavi prodajom plastičnih kutija, proizvodnjom polica i zidnih nosača. Za klijenta je urađeno grafičko rešenje, izrada web sajta i SEO optimizacija. Sajt sadrži Galeriju, Kontakt stranicu, stranicu sa proizvodima. Sajt je responsivan i proilagođen svim veličinama ekrana.</p>
            <p class="klijent"><strong>Klijent:</strong>&nbsp; Unikom Plus</p>
            <p class="godina"><strong>Godina izrade:</strong>&nbsp;2020</p>
            <a href="http://www.kutijeklaseri.com/" class="btn btn-default btnredirect" target="_blanc">Poseti stranicu &nbsp;<i class="fas fa-caret-right"></i></a>
          </div>
        </div>
      </div>
    </section>
