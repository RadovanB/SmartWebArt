...
<html lang="sr">
  <head>
    ...
    <title>Izrada web sajtova | Cryptocurrency Bussines School | Održavanje sajtova</title>
    <!-- Bootstrap -->
 ...
 <!-- Header End -->
  ...
  <!-- Main START -->
    <section class="reference-full">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <h1>CRYPTOCURRENCY BUSSINES SCHOOL</h1>
            <img src="/img/crypto-ref.jpg" alt="Cryptocurrency Bussines School" class="img-responsive">
          </div>
          <div class="col-md-4 desc">
            <h3>Kratak opis projekta</h3>
            <p>Sajt je rađen u tehnologijama HTML5, CSS3, JavaScript, Bootstrap 4, PHP i MySQL. Poseduje unikatan dizajn i prilagođen je svim uređajima. Od naprednih funkcija poseduje mogućnost prijavljivanja na newsletter, online skidanje brošure sa sajta,mogućnost online apliciranja na određeni program. Sajt ima sopstvenu bazu i svi podaci se čuvaju u njoj. Urađena je integracija sa PayPal i CoinMarket načinom plaćanja. Poseduje mogućnost logovanja preko svog naloga na CMS, preko kojeg realizovano slanje poruka korisnicima koji su prijavljeni na newsletter.</p>
            <p class="klijent"><strong>Klijent:</strong>&nbsp; Nikola Mitić</p>
            <p class="godina"><strong>Godina izrade:</strong>&nbsp;2020</p>
            <a href="https://cb-school.org/" class="btn btn-default btnredirect" target="_blanc">Poseti stranicu &nbsp;<i class="fas fa-caret-right"></i></a>
          </div>
        </div>
      </div>
    </section>
